    ...
    <section class="contacts">
        <div class="container">
            ...
            <div class="contacts-wrapper">
                ...
                <div class="contact-block">
                    <a href="tel:<?=preg_replace('/[^0-9]/', '', $phone);?>" class="phone">
                        <?=$phone?></a>
                </div>
                <div class="contact-block">
            ...
            <form class="paypal" method="get" autocomplete="off">
                ...
                <div class="form-block">
                    ...
                    <span class="main__form-select-wrap form-block">
                        <input class="main__form-select" readonly="" type="text" name="pool" placeholder="<?=$pools_types[0]['color_name']?>"
                            value="<?=$pools_types[0]['color_name']?>">
                        <span class="main__form-submenu" style="display: none;">
                            <?php foreach($pools_types as $pool){?>
                            <span>
                                <?=$pool['color_name']?></span>
                            <?php } ?>
                        </span>
                    </span>
                </div>
                <div class="form-block">
                    ...
                    <span class="main__form-select-wrap form-block">
                        <input class="main__form" name="babbles" type="text" placeholder="<?//=$bubbles[0]['title']?>"
                            value="<?//=$bubbles[0]['title']?>">
                        <span class="main__form-submenu" style="display: none;">
                ...
                <div class="form-block">
                    ...
                    <input type="radio" name="size" class="radio" id="size<?=$i?>" <?=($i==5)?'checked':'';?> value="
                    <?=$pool['size']?>" data-price="
                    <?php price_value($pool['price'], $pool['sale_price'])?>"/>
                    <label for="size<?=$i?>">
                        <?=$pool['size']?> см</label>
                    <?php $i++;}?>
                </div>
        ...
        <div class="form-wrapper styled-form popup-make-order">
            ...
            <form action="order_pool" autocomplete="off" class="validating">
                ...
                <div class="form-block">
                    ...
                    <input type="radio" name="size" class="radio" id="size<?=$i?>" <?=($i==100)?'checked':'';?> value="
                    <?=$pool['size']?>" data-price="
                    <?php price_value($pool['price'], $pool['sale_price'])?>"/>
                    <label for="size<?=$i?>">
                        <?=$pool['size']?> см</label>
...
<form class="web_pay" action="<?=$form_actions[$pay_data]['action'];?>" data-type="<?=$pay_data?>" <?php if($pay_data==2){echo
