     ...
     <main class="container-fluid content">
          ...
          <section class="main-advantages">
               ...
               <div class="main-wrapper advan-slider">
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon1.png" alt="Более 5000 довольных клиентов" /></div>
                    ...
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon2.png" alt="Безопасные материалы" /></div>
                         <div class="desc-block">
                              <p>Безопасные</p>
                    ...
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon3.png" alt="Доставка в любой город" /></div>
                         <div class="desc-block">
                              <p>Доставка</p>
                    ...
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon4.png" alt="Два размера" /></div>
                         <div class="desc-block">
                              <p>Два размера</p>
                    ...
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon5.png" alt="Занимает мало места" /></div>
                         <div class="desc-block">
                              <p>Занимает</p>
                    ...
                    <div class="advan-block slide">
                         <div class="icon-block"><img src="<?=get_template_directory_uri()?>/img/adv-icon6.png" alt="Съемный чехол" /></div>
                         <div class="desc-block">
                              <p>Съемный чехол</p>
                    ...
                    <div class="slide">
                         <div class="clients-block">
                              <div class="img-wrapper">
                                   <div class="img-block">
                                   <a href="#">
                                        <img src="<?=get_template_directory_uri()?>/img/client1.png" alt="Анна Хилькевич" />
                                   </a>
                                   </div>
                                   <a href="#"></a>
                              </div>
                    ...
                    <div class="slide">
                         <div class="clients-block">
                              <div class="img-wrapper">
                                   <div class="img-block">
                                   <a href="#">
                                        <img src="<?=get_template_directory_uri()?>/img/client2.png" alt="Ксения Бородина" />
                                   </a>
                                   </div>
                                   <a href="#"></a>
                              </div>
                    ...
                    <div class="slide">
                         <div class="clients-block">
                              <div class="img-wrapper">
                                   <div class="img-block">
                                   <a href="#">
                                        <img src="<?=get_template_directory_uri()?>/img/client3.png" alt="Татьяна Волосожар" />
                                   </a>
                                   </div>
                                   <a href="#"></a>
                              </div>
          ...
          <section class="main-userfulness">
               ...
               <div class="userfulness-center">
                    <div class="use-block pink">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo1.png" alt="Досуг для всей семьи" /></div>
                    ...
                    <div class="use-block purp">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo2.png" alt="Моторика" /></div>
                         <div class="use-block-desc">
                    ...
                    <div class="use-block orng">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo3.png" alt="Массажный эффект" /></div>
                         <div class="use-block-desc">
                    ...
                    <div class="use-block orng">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo4.png" alt="детский восторг" /></div>
                         <div class="use-block-desc">
                    ...
                    <div class="use-block purp">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo5.png" alt="свободное время" /></div>
                         <div class="use-block-desc">
                    ...
                    <div class="use-block pink">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/use-photo6.png" alt="развитие" /></div>
                         <div class="use-block-desc">
          ...
          <section class="main-compound">
               ...
               <div class="comp-wrapper">
                    <div class="material">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/comp1.png" alt="Ткань" /></div>
                    ...
                    <div class="material">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/comp2.png" alt="Основание и дно" /></div>
                    <div class="wrap-mat-title">
                    ...
                    <div class="material">
                         <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/comp3.png" alt="Шары" /></div>
                         <div class="wrap-mat-title">
                    ...
                    <div class="colors-wrapper">
                         <div class="pull-wrapper">
                              ...
                              <div class="pull-color">
                                   <div class="color">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/pull1.png" alt="светло-серый" /></div>
                                   <div class="title">светло-серый</div>
                                   </div>
                                   <div class="color">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/pull2.png" alt="темно-серый" /></div>
                                   <div class="title">темно-серый</div>
                                   </div>
                                   <div class="color">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/pull3.png" alt="розовый" /></div>
                                   <div class="title">розовый</div>
                                   </div>
                                   <div class="color">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/pull4.png" alt="мятный" /></div>
                                   <div class="title">мятный</div>
                                   </div>
                                   <div class="color">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/pull5.png" alt="хаки" /></div>
                    ...
                    <div class="wrap-balls">
                         <div class="balls-wrapper">
                              <div class="check-ball">
                                   ...
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color1.jpg" alt="Фиолетовый" /></div>
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color2.jpg" alt="Белый" /></div>
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color3.jpg" alt="Розовый" /></div>
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color4.jpg" alt="Серый" /></div>
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color5.jpg" alt="Желтый" /></div>
                                   <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color6.jpg" alt="Синий" /></div>
                                   </div>
                              </div>
                              <div class="checked-ball">
                                   <div class="img-block"><img src="<?=get_template_directory_uri()?>/img/color1.jpg" alt="" /></div>
                                   <div class="desc">Фиолетовый</div>
                              </div>
                         </div>
                         <div class="bottom check-ball-wrapper">
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color7.jpg" alt="Голубой" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color8.jpg" alt="Мятный" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color9.jpg" alt="Черный" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color10.jpg" alt="Зеленый" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color11.jpg" alt="Прозрачный" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color1.jpg" alt="Фиолетовый" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color2.jpg" alt="Белый" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color3.jpg" alt="Розовый" /></div>
                              <div class="ball"><img src="<?=get_template_directory_uri()?>/img/color4.jpg" alt="Серый" /></div>
